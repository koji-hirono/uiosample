...
echo "===> Spawn gogtp5g-link"
ip netns exec CL ./gogtp5g-link add gtp5gtest --ran &
echo $! > gogtp5g-link.pid
sleep 0.1
ip netns exec CL ./gogtp5g-tunnel add qer gtp5gtest 1:123 --qfi 9
ip netns exec CL ./gogtp5g-tunnel add qer gtp5gtest 1:321 --qfi 9
ip netns exec CL ./gogtp5g-tunnel add far gtp5gtest 1:1 --action 2
ip netns exec CL ./gogtp5g-tunnel add far gtp5gtest 1:2 --action 2 \
	--hdr-creation 0 78 30.30.0.1 2152
ip netns exec CL ./gogtp5g-tunnel add pdr gtp5gtest 1:1 --pcd 1 --hdr-rm 0 \
	--ue-ipv4 60.60.0.2 --f-teid 87 30.30.0.2 --far-id 1 --qer-id 321
